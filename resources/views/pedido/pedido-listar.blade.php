...
@section('breadcrumb')
    ...
    <ol class="toolbar">
        ...
        <li class="btn-item"><a title="Recargar" href="#" class="fa fa-refresh" aria-hidden="true" onclick='window.location.replace("/admin/pedidos/listado");'><span>Recargar</span></a></li>
    </ol>
@endsection
@section('contenido')
    <?php
