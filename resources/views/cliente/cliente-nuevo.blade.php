            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                 ...
                 <div class="form-group col-lg-6">
                    ...
                    <input type="text" id="txtCodigoPostal" name="txtCodigoPostal" class="form-control" value="{{$cliente->codigo_postal or ''}}">
                </div>

                <div class="form-group col-lg-6">
                    <label>DNI:</label>
                    <input type="text" id="txtDni" name="txtDni" class="form-control" value="{{$cliente->dni or ''}}">
                </div>

                <div class="form-group col-lg-6">
                    <label>Localidad</label>
                    <select name="lstLocalidad" id="lstLocalidad" class="form-control selectpicker" data-live-search="true">
                        <option value="" disabled selected>Seleccionar</option>
                            @for ($i = 0; $i < count($array_localidades); $i++)
                                @if (isset($cliente) and $array_localidades[$i]->idlocalidad == $cliente->fk_idlocalidad)
